...
<body>
    <div id = "head">
        <h1 id = "h1" class="rainbow"><b>SUPPLIER</b></h1>
    </div> 
    <div>
        <ul class = "navigation">        
    ...
    <div class = "PostAdvertisement" id = "PostAdvertisement" style = "display:none;">
        ...
        <form action = "utilities/advertisementdetails.php" method = "POST" target="DummyFrame">
            ...
            <br>
            <button style = "text-align-last:center; margin-left: 4%;">Submit</button>
        </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', 
            function(){
                Typed.new('.entry',{
                strings: ["Hi Supplier!", "Everyone is a Customer for somebody", "Or", "A Supplier to somebody."],
                typeSpeed: 2});
            });
