...
<body>
    <div id = "head">
        <h1 id = "h1" class="rainbow"><b>ADMIN</b></h1>
    </div>
    ...
    <div class="GiveFarmingTips" id="GiveFarmingTips" style="display:none;">
        ...
        <form action="utilities/givefarmingtips.php" method="POST" target="DummyFrame">
            <table style = "width:70px; color:black; margin-left:40%;">
                <tr>
                    <td>Farming Tips:</td>
            ...
            <br>
            <button style = "margin-left:3%;"> Submit </button>
        </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', 
            function(){
                Typed.new('.entry',{
                strings: ["Hi Admin!", "All your hard work around here", "doesn’t go unnoticed."],
                typeSpeed: 2});
            });
